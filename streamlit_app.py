...
# ====== ARIMA-ANFIS ABC ======
    ...
    try:
        # Ambil hasil test dari session_state
        ...
        # Ambil prediksi ANFIS ABC dari session_state
        ...
        # Buat tanggal
        start_date_test = pd.to_datetime("2022-01-03")
        ...
        st.error(f"❌ Terjadi kesalahan saat menghasilkan prediksi hybrid: {e}")
